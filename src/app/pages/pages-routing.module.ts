...
const routes: Routes = [{
  ...
  children: [
    ...
    {
      path: 'almacenistas',
      loadChildren: () => import('./almacenistas/almacenistas.module')
      .then(m => m.AlmacenistasModule),
    },
    {
      path: 'proveedor',
    ...
    },
    {
      ...
      loadChildren: () => import('./inventarioproducto/inventarioproducto.module')
      .then(m => m.InventarioproductoModule),
    },
    {
      path: 'dashboard',
